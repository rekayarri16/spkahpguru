			...
			<tr>
				...
				<td class="right aligned collapsing">
					<form method="post" action="kriteria.php">
						...
						<button type="submit" name="delete" class="ui mini red left labeled icon button" onclick="return confirm('Apakah Anda yakin ingin menghapus kriteria ini?')"><i class="right remove icon"></i>DELETE</button>
					</form>
				</td>
			</tr>
		<?php } ?>
